...
class EmbeddingGenerator:
            ...
            try:
                ...
                if uncached_texts:
                    ...
                    for idx, embedding_data in zip(uncached_indices, response.data):
                        ...
                        # Cache the embedding
                        if self.cache_dir:
                            await self._cache_embedding(uncached_texts[uncached_indices.index(idx)], embedding)
    ...
    async def generate_code_embeddings(
        ...
        if self.config.generate_interpreted and description:
            ...
            interpreted_text = self.truncate_text(interpreted_text, self.config.max_tokens)
