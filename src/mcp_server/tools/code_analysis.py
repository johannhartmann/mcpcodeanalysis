...
from src.database.models import Class, File, Function, Import, Module, Repository
...
class CodeAnalysisTools:
    ...
    def __init__(self, db_session: AsyncSession, mcp: FastMCP):
    ...
    async def register_tools(self):
        ...
        @self.mcp.tool(
            name="get_code",
            description="Get code content for an entity"
        )
        async def get_code(request: GetCodeRequest) -> Dict[str, Any]:
            ...
            try:
                ...
                # Get code content
                raw_content, contextual_content = self.code_extractor.get_entity_content(
                    file_path,
                    request.entity_type,
                    entity.start_line,
                    entity.end_line,
                ...
                return {
                    ...
                    "code": contextual_content if request.include_context else raw_content,
        ...
        async def find_usages(
            entity_type: str = Field(
                ..., 
                description="Entity type: function or class"
            ),
