...
class GitHubMonitor:
    ...
    async def get_repository_info(self, repo_url: str, token: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            while True:
                ...
                if page > 10:  # Max 1000 commits
                    logger.warning(f"Too many commits for {owner}/{repo}, stopping at 1000")
                    break
    ...
    async def check_rate_limit(self, token: Optional[str] = None) -> Dict[str, Any]:
