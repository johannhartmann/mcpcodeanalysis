...
def get_version_info(package_name: str = "mcp-code-analysis-server") -> VersionInfo:
    ...
    try:
        ...
        pre_release = version_and_prerelease[1] if len(version_and_prerelease) > 1 else None
...
def is_compatible_version(required_version: str, current_version: str | None = None) -> bool:
    """
