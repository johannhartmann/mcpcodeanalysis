...
class TestOpenAIClient:
    ...
    def test_init_from_settings(self, openai_client):
    ...
    @pytest.mark.asyncio
    async def test_generate_embedding_api_error(self, openai_client):
    ...
    @pytest.mark.asyncio
    async def test_generate_embedding_unexpected_error(self, openai_client):
    ...
    def test_truncate_text_short(self, openai_client):
        """Test text truncation with short text."""
        text = "Short text"
        result = openai_client._truncate_text(text)
        assert result == text
    
    def test_truncate_text_long(self, openai_client):
    ...
    @pytest.mark.asyncio
    async def test_generate_embeddings_batch_empty(self, openai_client):
    ...
    @pytest.mark.asyncio
    async def test_generate_embeddings_batch_with_errors(self, openai_client):
    ...
    @pytest.mark.asyncio
    async def test_generate_embeddings_batch_metadata_mismatch(self, openai_client):
    ...
    @pytest.mark.asyncio
    async def test_generate_embeddings_batch_large(self, openai_client):
    ...
    @pytest.mark.asyncio
    async def test_test_connection_success(self, openai_client):
