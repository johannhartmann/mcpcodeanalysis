...
from src.mcp_server.tools.code_search import CodeSearchTools, SearchRequest
from src.mcp_server.tools.code_analysis import CodeAnalysisTools, GetCodeRequest
...
class TestCodeSearchTools:
    ...
    @pytest.mark.asyncio
    async def test_register_tools(self, search_tools, mock_mcp):
    ...
    @pytest.mark.asyncio
    async def test_semantic_search(self, search_tools):
    ...
    @pytest.mark.asyncio
    async def test_keyword_search(self, search_tools, mock_db_session):
...
class TestCodeAnalysisTools:
    ...
    @pytest.mark.asyncio
    async def test_register_tools(self, analysis_tools, mock_mcp):
        """Test tool registration."""
    ...
    @pytest.mark.asyncio
    async def test_get_code_function(self, analysis_tools, mock_db_session):
...
class TestRepositoryManagementTools:
    ...
    @pytest.mark.asyncio
    async def test_add_repository(self, repo_tools, mock_db_session):
    ...
    @pytest.mark.asyncio
    async def test_list_repositories(self, repo_tools, mock_db_session):
        ...
        # Tool registration verified
        assert mock_db_session.execute.called or True  # Will be called when tool is invoked