...
class TestCodeProcessor:
    ...
    @pytest.mark.asyncio
    async def test_process_file_unsupported(self, code_processor, mock_file_record):
    ...
    @pytest.mark.asyncio
    async def test_extract_entities(self, code_processor, sample_entities):
    ...
    @pytest.mark.asyncio
    async def test_clear_file_entities(self, code_processor, mock_db_session):
    ...
    @pytest.mark.asyncio
    async def test_process_files(self, code_processor, mock_file_record):
    ...
    @pytest.mark.asyncio
    async def test_get_file_structure(self, code_processor, mock_file_record, mock_db_session):
