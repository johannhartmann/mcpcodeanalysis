...
class TestGitSync:
    ...
    def test_get_repo_path(self, git_sync):
    ...
    def test_extract_owner_repo_https(self, git_sync):
    ...
    def test_extract_owner_repo_ssh(self, git_sync):
    ...
    def test_extract_owner_repo_invalid(self, git_sync):
    ...
    @pytest.mark.asyncio
    async def test_clone_repository_success(self, git_sync, mock_repo):
    ...
    @pytest.mark.asyncio
    async def test_clone_repository_with_token(self, git_sync, mock_repo):
    ...
    @pytest.mark.asyncio
    async def test_clone_repository_already_exists(self, git_sync, mock_repo):
    ...
    @pytest.mark.asyncio
    async def test_clone_repository_git_error(self, git_sync):
    ...
    @pytest.mark.asyncio
    async def test_update_repository_success(self, git_sync, mock_repo):
    ...
    @pytest.mark.asyncio
    async def test_update_repository_not_exists(self, git_sync, mock_repo):
    ...
    @pytest.mark.asyncio
    async def test_update_repository_invalid_repo(self, git_sync, mock_repo):
    ...
    def test_get_repository_exists(self, git_sync, mock_repo):
    ...
    def test_get_repository_not_exists(self, git_sync):
        """Test getting non-existent repository."""
        repo = git_sync.get_repository("https://github.com/test-owner/test-repo")
        assert repo is None

    def test_get_file_hash(self, git_sync, tmp_path):
    ...
    @pytest.mark.asyncio
    async def test_get_changed_files(self, git_sync, mock_repo):
    ...
    @pytest.mark.asyncio
    async def test_scan_repository_files(self, git_sync, tmp_path):
    ...
    def test_detect_language(self, git_sync):
    ...
    def test_get_commit_info(self, git_sync, mock_repo):
    ...
    @pytest.mark.asyncio
    async def test_get_recent_commits(self, git_sync, mock_repo):
