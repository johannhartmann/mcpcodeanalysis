...
class TestGitHubClient:
    ...
    @pytest.mark.asyncio
    async def test_context_manager(self, github_client):
    ...
    @pytest.mark.asyncio
    async def test_check_rate_limit_ok(self, github_client):
    ...
    @pytest.mark.asyncio
    async def test_check_rate_limit_exhausted(self, github_client):
        """Test rate limit check when limit is exhausted."""
        github_client._rate_limit_remaining = 5
        github_client._rate_limit_reset = datetime.now(timezone.utc).replace(
    ...
    def test_update_rate_limit(self, github_client, mock_response):
    ...
    @pytest.mark.asyncio
    async def test_request_success(self, github_client, mock_response):
    ...
    @pytest.mark.asyncio
    async def test_request_rate_limit_error(self, github_client):
    ...
    @pytest.mark.asyncio
    async def test_request_github_error(self, github_client):
    ...
    @pytest.mark.asyncio
    async def test_get_repository(self, github_client, mock_response):
    ...
    @pytest.mark.asyncio
    async def test_get_default_branch(self, github_client):
    ...
    @pytest.mark.asyncio
    async def test_get_commits(self, github_client, mock_response):
    ...
    @pytest.mark.asyncio
    async def test_get_commits_pagination(self, github_client):
    ...
    @pytest.mark.asyncio
    async def test_create_webhook(self, github_client, mock_response):
    ...
    @pytest.mark.asyncio
    async def test_get_file_content(self, github_client, mock_response):
    ...
    @pytest.mark.asyncio
    async def test_get_changed_files(self, github_client, mock_response):
