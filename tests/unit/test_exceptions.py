...
class TestParsingError:
    ...
    def test_parsing_error_full(self):
...
class TestNotFoundError:
    ...
    def test_not_found_error_minimal(self):
        """Test not found error with minimal info."""
        error = NotFoundError("Resource not found")
        assert error.message == "Resource not found"
        assert error.details == {}
    
    def test_not_found_error_full(self):
...
class TestWebhookError:
    ...
    def test_webhook_error_minimal(self):
    ...
    def test_webhook_error_full(self):
